...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "parallax_edge.js"},
      { load: "parallax_edgeActions.js"}];
...
var plSTF="width",ctrPlS="both",minPlW="0",maxPlW=undefined,plWidth="1950px",plHeight="6400px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['719px', '323px','23.7%','5.4%','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/preloader5.gif','0px','0px']
    },
    {
        id: 'Text7',
        type: 'text',
        rect: ['554px', '155px','auto','auto','auto', 'auto'],
        text: "Loading... Please wait",
        align: "center",
        font: ['Lucida Console, Monaco, monospace', 60, "rgba(0,0,0,0.77)", "400", "none", "normal"]
    }]};//simpleContent
